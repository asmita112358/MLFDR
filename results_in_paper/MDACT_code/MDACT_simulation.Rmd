...
res_fdr <- Parallelsim_mu_fdr(c(0.2,0.2,0.6,0),pras=pras,sim.num=4.8e5,control.method = "FDR", sig_level=0.1,num_runs=1000)
res_fdr[["result_tab"]]
...
pras <- c(m/sqrt(1+delta^2),m/sqrt(1+delta^2)*delta)##mean of the z-scores distribution
res_fdr <- Parallelsim_mu_fdr(c(0.2,0.2,0.6,0),pras=pras,sim.num=4.8e5,control.method = "FDR", sig_level=0.05,num_runs=1000)
res_fdr[["result_tab"]]


pras <- c(m/sqrt(1+delta^2),m/sqrt(1+delta^2)*delta)##mean of the z-scores distribution
res_fdr <- Parallelsim_mu_fdr(c(0.2,0.2,0.6,0),pras=pras,sim.num=4.8e5,control.method = "FWER", sig_level=0.05,num_runs=1000)
res_fdr[["result_tab"]]

pras <- c(m/sqrt(1+delta^2),m/sqrt(1+delta^2)*delta)##mean of the z-scores distribution
res_fdr <- Parallelsim_mu_fdr(c(0.1,0.02,0.875,0.005),pras=pras,sim.num=4.8e5,control.method = "FDR", sig_level=0.05,num_runs=1000)
res_fdr[["result_tab"]]
```
